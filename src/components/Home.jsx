...
const HERO_POINTS = [
  'Reach map for the Mithi corridor in Mumbai',
  'Air quality and weather on the selected area',
  'Every figure labelled by source',
]

const STATS = [
  { value: '17', unit: 'km', label: 'Approximate Mithi corridor' },
  { value: '213', unit: '', label: 'Garbage sites mapped' },
  { value: '7', unit: '', label: 'Flood / water image pairs' },
  { value: '7', unit: '', label: 'Monthly silt overlays' },
]
    ...
    <div className="lp-hero-inner">
      <div className="lp-hero-copy">
        ...
        <p className="lp-anim" style={stagger(2)}>
          Track modelled layers, air quality and river health on one map of
          Mumbai&rsquo;s Mithi River — with every number labelled by where it came from and how far it can be
          trusted.
        </p>
  ...
  <footer className="lp-footer">
    <div className="lp-footer-inner">
      <div>
        <BrandMark />
        <p>
          Environmental monitoring for the Mithi River in Mumbai, assembled from satellite class
          overlays and the ClimateEye air and weather backend.
        </p>
      </div>
    ...
    <div className="lp-footer-bottom">
      © {new Date().getFullYear()} Mithi River Eye. Satellite class overlays for silt, salinity,
      lithology and flood extent ·
